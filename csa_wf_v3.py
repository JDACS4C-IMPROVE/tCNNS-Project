...
import tcnns_preprocess_improve
import tcnns_train_improve
import tcnns_infer_improve
...
for source_data_name in source_datasets:
    ...
    for split in split_nums:
        ...
        for target_data_name in target_datasets:
            ...
            #result = subprocess.run(preprocess_run, capture_output=True, text=True, check=True)
            #result = subprocess.run(preprocess_run, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, check=True)
            ...
            if model_outdir.exists() is False:
                ...
                #result = subprocess.run(train_run, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, check=True)
            ...
            #                        text=True, check=True)
            #result = subprocess.run(infer_run, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, check=True)
