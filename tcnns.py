...
additional_definitions = [
    ...
    {   "name": "drug_conv1_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for drug convolutional layer 1",
    },
    {   "name": "drug_conv2_out",
        "type": int, 
    ...
    {   "name": "drug_conv2_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for drug convolutional layer 2",
    },
    {   "name": "drug_conv3_out",
        "type": int, 
    ...
    {   "name": "drug_conv3_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for drug convolutional layer 3",
    },
    {   "name": "cell_conv1_out",
        "type": int, 
    ...
    {   "name": "cell_conv1_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for cell convolutional layer 1",
    },
    {   "name": "cell_conv2_out",
        "type": int, 
    ...
    {   "name": "cell_conv2_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for cell convolutional layer 2",
    },
    {   "name": "cell_conv3_out",
        "type": int, 
    ...
    {   "name": "cell_conv3_pool",
        "type": int, 
        "help": "number for pooling stride and max pooling width for cell convolutional layer 3",
    },
    {   "name": "bias_constant",
        "type": float, 
